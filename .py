...
'interest_rate':
[2.75,2.5,2.5,2.5,2.5,2.5,2.5,2.25,2.25,2.25,2,2,2,1.75,1.75,1.75,1.75,1.75,1.75,1.75,1.75,1.75,1.75,1.75,1.75,1.75]
'unemployment_rate':
...
df =    
pd.DataFrame(stock_market,columns=['year','month','interest_state','unemployment_rate','stock_index'])
plt.scatter(df['interest_rate'],df['stock_index'],color='red')
plt.title('stock index price vs interst rate ',fontsize=14)
